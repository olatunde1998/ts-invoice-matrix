import { DeleteClientRequest } from "@/app/services/clients.request";
...
export default function DeleteClient({
  ...
  // refetch Clients using Query client
  ...
  const handleDelete = async () => {
    setIsDeleting(true);
    try {
      await DeleteClientRequest(deleteClientID);
    ...
    <>
      <div className="bg-white p-8 rounded-[0.63rem] lg:w-[80%] mx-auto">
        ...
        <p className="text-md  text-center text-gray-500">
          ...
          <span className="text-[#D92D20]"> Client ? </span> This action cannot
          be undone
        </p>
